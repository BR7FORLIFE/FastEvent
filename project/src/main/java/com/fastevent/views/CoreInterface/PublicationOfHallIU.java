...
public class PublicationOfHallIU {
    ...
    public static HBox publicateHall() {
        ...
        for (Label label : new Label[] {
                nameOfHallLabel, ubicationOfHallLabel, priceOfHallLabel, capacityOfHallLabel, dimensionOfHallLabel
        }) {
        ...
        for (TextField textField : new TextField[] {
                nameOfHallField, ubicationOfHallField, priceOfHallField, capacityOfHallField, dimensionOfHallField
        }) {
            textField.setStyle(
