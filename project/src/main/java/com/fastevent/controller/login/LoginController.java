...
/*
 * esta clase nos permite iniciar sesion al usuario con su nameUser y password
 * previamente
 */
public class LoginController {
    ...
    /**
     * este metodo nos permite recuperar tanto el nombre de usuario y contraseña de
     * un VarArgs
     * 
     * VarArgs = numero arbitrarios de argumentos
     * 
     * @param currentFrame // frame actual o anterior que nos permite destruir y
     *                     ejecutar el siguiente
     * @param fields       // numero arbitrarios de nodos que vienen del paquete
     ...
     * 
     * se coloca de manera privada para que ninguna clase pueda acceder a ella de
     * manera arbitraraia
     */
        ...
        try (FileReader reader = new FileReader(pathConst.getUserJSon())) {
            ...
            if (users.size() != 0) {
                ...
                if (userFound) {
                    ...
                    System.out.println("el usuario no se encuentra registrado en la plataforma");
                }

            } else {
                System.out.println("Esperando registros de usuarios...");
            }
